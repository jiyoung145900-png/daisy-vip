    ...
    switch (activeTab) {
      case 'home':
        return (
          <HomeSection 
            t={t} // 번역 전달
            innerLogo={innerLogo} slideImages={slideImages} members={members} 
      ...
      case 'manager':
        return (
          <ManagerSection 
            t={t} // 번역 전달
            regions={regions} selectedRegion={selectedRegion} setSelectedRegion={setSelectedRegion} 
      ...
      case 'event':
        return isEventLoading ? (
          ...
          <EventSection 
            t={t} // 번역 전달
            user={safeUser} userPoint={safeUser.diamond} onUpdatePoint={onUpdatePoint}
      ...
      case 'video':
        return (
          <VideoSection 
            t={t} // 번역 전달
            videoCategories={videoCategories} selectedCategory={selectedCategory} 
      ...
      case 'mypage':
        return (
          <MyPageSection 
            t={t} // 번역 전달
            user={safeUser} onBack={() => setActiveTab('home')} onLogout={() => setShowLogoutConfirm(true)} 
